 ...
 */
function dental_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'dental_content_width', 640 );
}
add_action( 'after_setup_theme', 'dental_content_width', 0 );
...
function dental_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'dental' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'dental' ),
